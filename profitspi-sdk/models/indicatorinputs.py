...
class Indicatorinputs(object):
    ...
    def __init__(self, input_alias=None, _configuration=None):  # noqa: E501
        """Indicatorinputs - a model defined in Swagger"""  # noqa: E501
        if _configuration is None:
            _configuration = Configuration()
        self._configuration = _configuration

        self._input_alias = None
    ...
    def input_alias(self):
        """Gets the input_alias of this Indicatorinputs.  # noqa: E501


        :return: The input_alias of this Indicatorinputs.  # noqa: E501
        :rtype: str
        """
        return self._input_alias

    @input_alias.setter
    def input_alias(self, input_alias):
        """Sets the input_alias of this Indicatorinputs.


        :param input_alias: The input_alias of this Indicatorinputs.  # noqa: E501
        :type: str
        """

        self._input_alias = input_alias
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(Indicatorinputs, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, Indicatorinputs):
            return False
